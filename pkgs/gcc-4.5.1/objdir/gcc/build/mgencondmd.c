...
#undef TARGET_SAHF
#undef TARGET_ZERO_EXTEND_WITH_AND
#undef TARGET_SHIFT
#undef TARGET_SHIFT1
#undef TARGET_USE_XCHGB
#undef TARGET_CMPXCHG8B
#undef TARGET_USE_CLTD
#undef TARGET_FUSE_CMP_AND_BRANCH
#undef TARGET_NOT_UNPAIRABLE
#undef TARGET_80387
#undef TARGET_USE_FANCY_MATH_387
#undef TARGET_MIX_SSE_I387
#undef TARGET_SHORTEN_X87_SSE
#undef TARGET_FISTTP
#undef TARGET_USE_HIMODE_FIOP
#undef TARGET_AVX
#undef TARGET_AES
#undef TARGET_SSE
#undef TARGET_PREFETCH_SSE
#undef TARGET_SSE_MATH
#undef TARGET_SSE2
#undef TARGET_SSE3
#undef TARGET_SSSE3
#undef TARGET_SSE4_1
...
#undef TARGET_XOP
#undef TARGET_3DNOW
#undef TARGET_3DNOW_A 
#undef TARGET_FMA4
#undef TARGET_FUSED_MADD
#undef TARGET_CMOVE
#undef TARGET_LWP
#undef TARGET_STACK_PROBE
#undef TARGET_64BIT
#undef TARGET_POPCNT
#undef TARGET_AVOID_VECTOR_DECODE
#undef TARGET_PCLMUL
#undef TARGET_GNU_TLS
#undef TARGET_INTER_UNIT_CONVERSIONS
#undef TARGET_INTER_UNIT_MOVES
#undef TARGET_CRC32
#undef TARGET_CMPXCHG
#undef TARGET_PARTIAL_REG_STALL
#undef TARGET_BSWAP 
#undef TARGET_ABM 
#undef TARGET_USE_BT 
#undef TARGET_HIMODE_MATH 
#undef TARGET_SPLIT_LONG_MOVES 
#undef TARGET_USE_MOV0 
#undef TARGET_NOT_UNPAIRABLE 
#undef TARGET_NOT_VECTORMODE 
#undef TARGET_PROMOTE_QImode 
#undef TARGET_USE_VECTOR_FP_CONVERTS 
#undef TARGET_FAST_PREFIX 
#undef TARGET_GNU2_TLS 
#undef TARGET_PARTIAL_FLAG_REG_STALL 
#undef TARGET_DOUBLE_WITH_ADD 
#undef TARGET_QIMODE_MATH 


#define TARGET_SAHF (0)
#define TARGET_ZERO_EXTEND_WITH_AND (0)
#define TARGET_SHIFT (0)
#define TARGET_SHIFT1 (0)
#define TARGET_USE_XCHGB (0)
#define TARGET_CMPXCHG8B (0)
#define TARGET_USE_CLTD (0)
#define TARGET_FUSE_CMP_AND_BRANCH (0)
#define TARGET_NOT_UNPAIRABLE (0)
#define TARGET_80387 (0)
#define TARGET_USE_FANCY_MATH_387 (0)
#define TARGET_MIX_SSE_I387 (0)
#define TARGET_SHORTEN_X87_SSE (0)
#define TARGET_FISTTP (0)
#define TARGET_USE_HIMODE_FIOP (0)
#define TARGET_AVX (0)
#define TARGET_AES (0)
#define TARGET_SSE (0)
#define TARGET_PREFETCH_SSE (0)
#define TARGET_SSE_MATH (0)
#define TARGET_SSE2 (0)
#define TARGET_SSE3 (0)
#define TARGET_SSSE3 (0)
#define TARGET_SSE4_1 (0)
#define TARGET_SSE4_2 (0)
#define TARGET_SSE4A (0)
#define TARGET_ROUND (0)
#define TARGET_XADD (0)
#define TARGET_MMX (0)
#define TARGET_XOP (0)
#define TARGET_3DNOW (0)
#define TARGET_3DNOW_A (0)
#define TARGET_FMA4 (0)
#define TARGET_FUSED_MADD (0)
#define TARGET_CMOVE (0)
#define TARGET_LWP (0)
#define TARGET_STACK_PROBE (0)
#define TARGET_64BIT (0)
#define TARGET_POPCNT (0)
#define TARGET_AVOID_VECTOR_DECODE (0)
#define TARGET_PCLMUL (0)
#define TARGET_GNU_TLS (0)
#define TARGET_INTER_UNIT_CONVERSIONS (0)
#define TARGET_INTER_UNIT_MOVES (0)
#define TARGET_CRC32 (0)
#define TARGET_CMPXCHG (0)
#define TARGET_PARTIAL_REG_STALL (0)
#define TARGET_BSWAP (0)
#define TARGET_ABM (0)
#define TARGET_USE_BT (0)
#define TARGET_HIMODE_MATH (0)
#define TARGET_SPLIT_LONG_MOVES (0)
#define TARGET_USE_MOV0 (0)
#define TARGET_NOT_UNPAIRABLE (0)
#define TARGET_NOT_VECTORMODE (0)
#define TARGET_PROMOTE_QImode (0)
#define TARGET_USE_VECTOR_FP_CONVERTS (0)
#define TARGET_FAST_PREFIX (0)
#define TARGET_GNU2_TLS (0)
#define TARGET_PARTIAL_FLAG_REG_STALL (0)
#define TARGET_DOUBLE_WITH_ADD (0)
#define TARGET_QIMODE_MATH (0)
