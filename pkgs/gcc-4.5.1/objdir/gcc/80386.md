(define_conditions [
  ...
  (0 "TARGET_SSE4_1")
  (0 "(TARGET_CMOVE && !TARGET_PARTIAL_REG_STALL) && ( reload_completed)")
  (0 "AVX_VEC_FLOAT_MODE_P (V4SFmode)")
  ...
  (0 "X87_FLOAT_MODE_P (GET_MODE (operands[1]))
   ...
   && !((SSE_FLOAT_MODE_P (GET_MODE (operands[1]))
	&& (TARGET_64BIT || HImode != DImode))
	&& TARGET_SSE_MATH)")
  (0 "TARGET_SSE2 && ix86_binary_operator_ok (IOR, V16QImode, operands)")
  ...
  (0 "TARGET_SSE2 && ix86_binary_operator_ok (MINUS, V16QImode, operands)")
  ...
  (0 "TARGET_SSE2 && ix86_binary_operator_ok (XOR, V2DImode, operands)")
  (0 "(X87_FLOAT_MODE_P (GET_MODE (operands[1]))
   && TARGET_SAHF && !TARGET_CMOVE
   && (TARGET_USE_HIMODE_FIOP || optimize_function_for_size_p (cfun))
   && (GET_MODE (operands [3]) == GET_MODE (operands[1]))) && ( reload_completed)")
  ...
  (0 "TARGET_AVX && ix86_binary_operator_ok (UMAX, V8HImode, operands)")
  (0 "(TARGET_SSE || TARGET_3DNOW)
   && ix86_binary_operator_ok (PLUS, V8QImode, operands)")
  (0 "TARGET_80387 && TARGET_CMOVE
   && !(MEM_P (operands[2]) && MEM_P (operands[3]))")
  ...
  (0 "TARGET_SSE2 && ix86_binary_operator_ok (PLUS, V2DImode, operands)")
  (0 "TARGET_64BIT && !SIBLING_CALL_P (insn)
   && ix86_cmodel != CM_LARGE && ix86_cmodel != CM_LARGE_PIC")
  (0 "TARGET_MMX
   && !(MEM_P (operands[0]) && MEM_P (operands[1]))")
  (0 "TARGET_AVX && ix86_binary_operator_ok (SMIN, V16QImode, operands)")
  (0 "TARGET_AVX && ix86_binary_operator_ok (MINUS, V8HImode, operands)")
  ...
  (0 "TARGET_HIMODE_MATH
   && !(MEM_P (operands[1]) && MEM_P (operands[2]))")
  (0 "(TARGET_AVX) && ( reload_completed && REG_P (operands[1]))")
  (0 "TARGET_SSE2 && ix86_binary_operator_ok (US_MINUS, V16QImode, operands)")
  (0 "TARGET_SSE4_1 && ix86_binary_operator_ok (UMIN, V8HImode, operands)")
  (0 "AVX_VEC_FLOAT_MODE_P (V4DFmode)
   && ix86_binary_operator_ok (IOR, V4DFmode, operands)")
  (0 "TARGET_MMX && ix86_binary_operator_ok (XOR, V2SImode, operands)")
  (0 "TARGET_64BIT
   && ix86_match_ccmode (insn, CCGCmode)")
  (0 "TARGET_SSE4_1 && ix86_binary_operator_ok (SMAX, V4SImode, operands)")
  (0 "! TARGET_PARTIAL_REG_STALL && TARGET_CMOVE
   && (GET_MODE (operands[0]) == HImode
       || (GET_MODE (operands[0]) == QImode
	   && (TARGET_PROMOTE_QImode
	       || optimize_insn_for_size_p ())))")
  ...
  (0 "(TARGET_USE_FANCY_MATH_387
   && flag_unsafe_math_optimizations
   && can_create_pseudo_p ()) && ( 1)")
  (0 "TARGET_SSE2 && ix86_binary_operator_ok (AND, V16QImode, operands)")
  (0 "TARGET_USE_FANCY_MATH_387
   && !(SSE_FLOAT_MODE_P (SFmode) && TARGET_SSE_MATH)")
  (-1 "reload_completed
    && QI_REG_P (operands[0])
    ...
    && !(~INTVAL (operands[2]) & ~(255 << 8))
    && GET_MODE (operands[0]) != QImode")
  (0 "TARGET_SSE2 && ix86_binary_operator_ok (SS_PLUS, V16QImode, operands)")
  (0 "AVX_VEC_FLOAT_MODE_P (V8SFmode) && flag_finite_math_only
  ...
  (-1 "GET_MODE_SIZE (GET_MODE (operands[0])) <= UNITS_PER_WORD
   ...
   && peep2_regno_dead_p (0, FLAGS_REG)")
  (-1 "(ix86_binary_operator_ok (PLUS, DImode, operands)) && (!TARGET_64BIT)")
  (0 "TARGET_AVX && ix86_binary_operator_ok (MULT, V8HImode, operands)")
  (0 "TARGET_64BIT && ix86_binary_operator_ok (ASHIFT, DImode, operands)")
  (0 "TARGET_AVX && ix86_binary_operator_ok (SMAX, V16QImode, operands)")
  ...
  (0 "SSE_FLOAT_MODE_P (DFmode) && TARGET_SSE_MATH
   && !COMMUTATIVE_ARITH_P (operands[3])")
  (0 "TARGET_SSE2 && ix86_binary_operator_ok (XOR, V16QImode, operands)")
  (-1 "!TARGET_64BIT && !TARGET_INTEGER_DFMODE_MOVES")
  (0 "((SSE_FLOAT_MODE_P (TFmode) && TARGET_SSE_MATH)
  ...
  (0 "TARGET_SSE2 && ix86_binary_operator_ok (AND, V4SImode, operands)")
  (0 "TARGET_80387
    && (!(SSE_FLOAT_MODE_P (XFmode) && TARGET_SSE_MATH)
        || TARGET_MIX_SSE_I387)
    && reload_completed")
  ...
  (0 "TARGET_SSE2 && ix86_binary_operator_ok (UMAX, V16QImode, operands)")
  (0 "TARGET_80387 || (SSE_FLOAT_MODE_P (SFmode) && TARGET_SSE_MATH)")
  (0 "TARGET_80387 && X87_ENABLE_FLOAT (SFmode, SImode)
   && !(SSE_FLOAT_MODE_P (SFmode) && TARGET_SSE_MATH)
   && (TARGET_USE_SIMODE_FIOP || optimize_function_for_size_p (cfun))")
  ...
  (0 "((SSE_FLOAT_MODE_P (SFmode) && TARGET_SSE_MATH)
    || (TARGET_SSE2 && (SFmode == TFmode)))
   && reload_completed")
  (0 "TARGET_SSE3 && ix86_vec_interleave_v2df_operator_ok (operands, 0)")
  (0 "X87_FLOAT_MODE_P (GET_MODE (operands[1]))
   && TARGET_FISTTP
   && !((SSE_FLOAT_MODE_P (GET_MODE (operands[1]))
	&& (TARGET_64BIT || SImode != DImode))
  ...
  (0 "SSE_FLOAT_MODE_P (SFmode) && TARGET_SSE_MATH
   && !COMMUTATIVE_ARITH_P (operands[3])")
  (0 "TARGET_SSE4_1 && ix86_binary_operator_ok (SMAX, V16QImode, operands)")
  (0 "AVX_VEC_FLOAT_MODE_P (V2DFmode)
   && !(MEM_P (operands[0]) && MEM_P (operands[1]))")
  (0 "TARGET_SSE2 && ix86_binary_operator_ok (AND, V2DImode, operands)")
  (0 "(TARGET_SSE || TARGET_3DNOW_A)
  ...
  (0 "TARGET_80387
   && (!(SSE_FLOAT_MODE_P (DFmode) && TARGET_SSE_MATH)
       || TARGET_MIX_SSE_I387)
   && can_create_pseudo_p ()")
  (0 "TARGET_SSE2 && ix86_binary_operator_ok (MINUS, V2DImode, operands)")
  (0 "TARGET_USE_FANCY_MATH_387
   && flag_unsafe_math_optimizations
   && can_create_pseudo_p ()")
  (0 "TARGET_AVX && ix86_binary_operator_ok (SMIN, V8HImode, operands)")
  (0 "TARGET_SSE2")
  ...
  (-1 "(! TARGET_PARTIAL_REG_STALL || optimize_function_for_size_p (cfun))
   && (TARGET_SHIFT1 || optimize_function_for_size_p (cfun))
   && ix86_binary_operator_ok (ASHIFTRT, QImode, operands)")
  (0 "SSE_FLOAT_MODE_P (SFmode) && TARGET_MIX_SSE_I387
   && !COMMUTATIVE_ARITH_P (operands[3])
   && !(MEM_P (operands[1]) && MEM_P (operands[2]))")
  ...
  (0 "TARGET_MMX && ix86_binary_operator_ok (MULT, V4HImode, operands)")
  (0 "TARGET_80387
   && (!(SSE_FLOAT_MODE_P (DFmode) && TARGET_SSE_MATH)
       || TARGET_MIX_SSE_I387)
   && reload_completed")
  ...
  (0 "(((TARGET_80387
	...
	&& ((SImode == SImode
	    ...
	    || !(TARGET_INTER_UNIT_CONVERSIONS
	         || optimize_function_for_size_p (cfun)))))
   && can_create_pseudo_p ()) && ( 1)")
  (0 "TARGET_POPCNT && ix86_match_ccmode (insn, CCZmode)")
  (0 "(TARGET_SSE || TARGET_3DNOW_A) && !TARGET_64BIT")
  (0 "TARGET_AVX
  ...
  (0 "TARGET_64BIT
   && (TARGET_SHIFT1 || optimize_function_for_size_p (cfun))
   && ix86_binary_operator_ok (ASHIFTRT, SImode, operands)")
  (0 "(!TARGET_64BIT && TARGET_SSE2 && TARGET_INTER_UNIT_MOVES) && ( reload_completed)")
  (0 "!TARGET_64BIT && TARGET_SSE2 && TARGET_INTER_UNIT_MOVES")
  (0 "TARGET_64BIT && TARGET_MMX
   && !(MEM_P (operands[0]) && MEM_P (operands[1]))")
  (0 "AVX_VEC_FLOAT_MODE_P (V4DFmode) && flag_finite_math_only
   && ix86_binary_operator_ok (SMAX, V4DFmode, operands)")
  (0 "TARGET_SSSE3 && ix86_binary_operator_ok (MULT, V8HImode, operands)")
  ...
  (0 "TARGET_64BIT
   ...
   && ix86_match_ccmode (insn, CCGOCmode)
   && ix86_binary_operator_ok (ASHIFT, DImode, operands)")
  (0 "TARGET_MMX && ix86_binary_operator_ok (US_PLUS, V4HImode, operands)")
  (0 "TARGET_CMPXCHG")
  (0 "TARGET_SSE2 && reload_completed
  ...
  (0 "TARGET_AVX && TARGET_SSE_MATH")
  (0 "TARGET_AVX && ix86_binary_operator_ok (EQ, V8HImode, operands)")
  (-1 "ix86_match_ccmode (insn, CCNOmode)")
  (0 "!TARGET_64BIT
   && TARGET_80387 && X87_ENABLE_FLOAT (DFmode, DImode)
   && TARGET_SSE
   && reload_completed")
  (0 "TARGET_MMX && ix86_binary_operator_ok (XOR, V4HImode, operands)")
  (0 "TARGET_MMX && ix86_binary_operator_ok (AND, V8QImode, operands)")
  (0 "TARGET_SSE || TARGET_64BIT")
  (0 "TARGET_80387")
  (-1 "(ix86_match_ccmode (insn, CCNOmode)
  ...
  (0 "TARGET_MMX && ix86_binary_operator_ok (US_PLUS, V8QImode, operands)")
  (0 "X87_FLOAT_MODE_P (GET_MODE (operands[0]))
   && TARGET_CMOVE
  ...
  (0 "TARGET_AVX && ix86_binary_operator_ok (MULT, V4SImode, operands)")
  (0 "TARGET_SSE && TARGET_64BIT")
  (0 "TARGET_64BIT && !SIBLING_CALL_P (insn)")
  (-1 "(ix86_match_ccmode (insn, CCNOmode)
  ...
  (-1 "reload_completed && !SSE_REG_P (operands[0])
   && !SSE_REG_P (operands[1])")
  (0 "TARGET_80387 || SSE_FLOAT_MODE_P (SFmode)")
  (0 "(DImode != DImode || TARGET_64BIT)
   && SSE_FLOAT_MODE_P (DFmode) && TARGET_MIX_SSE_I387
   && (TARGET_INTER_UNIT_CONVERSIONS || optimize_function_for_size_p (cfun))")
  (0 "AVX_VEC_FLOAT_MODE_P (V8SFmode)
  ...
  (0 "AVX_VEC_FLOAT_MODE_P (V4SFmode) && flag_finite_math_only
   && ix86_binary_operator_ok (SMAX, V4SFmode, operands)")
  (0 "TARGET_80387 || (TARGET_64BIT && SSE_FLOAT_MODE_P (SFmode))")
  (-1 "ix86_match_ccmode (insn, CCNOmode)
   && !(MEM_P (operands[0]) && MEM_P (operands[1]))")
  (0 "!TARGET_SSE2 && TARGET_SSE
   && !(MEM_P (operands[0]) && MEM_P (operands[1]))")
  (0 "TARGET_3DNOW")
  (0 "(TARGET_MMX || (TARGET_SSE2 && V4HImode == V1DImode))
   && ix86_binary_operator_ok (PLUS, V4HImode, operands)")
  ...
  (-1 "REGNO (operands[0]) != REGNO (operands[1])
   && ((MMX_REG_P (operands[0]) && MMX_REG_P (operands[1])) 
       || (SSE_REG_P (operands[0]) && SSE_REG_P (operands[1])))")
  (0 "TARGET_SSE && ix86_binary_operator_ok (UNKNOWN, V4SFmode, operands)")
  (0 "AVX_VEC_FLOAT_MODE_P (V8SFmode)
  ...
  (0 "TARGET_80387 && !(SSE_FLOAT_MODE_P (SFmode) && TARGET_SSE_MATH)")
  (0 "TARGET_AVX && ix86_binary_operator_ok (PLUS, V4SImode, operands)")
  (0 "(SImode != DImode || TARGET_64BIT)
   && SSE_FLOAT_MODE_P (DFmode) && TARGET_SSE_MATH
   && reload_completed
   && (SSE_REG_P (operands[0])
  ...
  (0 "TARGET_64BIT
   && (!TARGET_PARTIAL_REG_STALL || optimize_function_for_size_p (cfun))")
  (0 "TARGET_AVX && ix86_vec_interleave_v2df_operator_ok (operands, 0)")
  (0 "SSE_FLOAT_MODE_P (DFmode)")
  (0 "TARGET_64BIT
   && (TARGET_SHIFT1 || optimize_function_for_size_p (cfun))
   && ix86_binary_operator_ok (LSHIFTRT, HImode, operands)")
  ...
  (0 "(SImode != DImode || TARGET_64BIT)
   && SSE_FLOAT_MODE_P (SFmode) && TARGET_SSE_MATH
   && (TARGET_INTER_UNIT_CONVERSIONS || optimize_function_for_size_p (cfun))")
  (0 "(TARGET_USE_FANCY_MATH_387 && X87_ENABLE_ARITH (SFmode))
   || (SSE_FLOAT_MODE_P (SFmode) && TARGET_SSE_MATH)")
  ...
  (0 "TARGET_80387
   && (!(SSE_FLOAT_MODE_P (SFmode) && TARGET_SSE_MATH)
       || TARGET_MIX_SSE_I387)")
  (0 "TARGET_AVX && ix86_binary_operator_ok (UMIN, V16QImode, operands)")
  (0 "TARGET_80387 && X87_ENABLE_ARITH (DFmode)
   && !(TARGET_SSE2 && TARGET_SSE_MATH)
   && !(MEM_P (operands[1]) && MEM_P (operands[2]))")
  ...
  (0 "X87_FLOAT_MODE_P (GET_MODE (operands[1]))
   && !TARGET_FISTTP
   && !SSE_FLOAT_MODE_P (GET_MODE (operands[1]))")
  (0 "!TARGET_64BIT && TARGET_GNU_TLS")
  (0 "TARGET_SSE2 && ix86_binary_operator_ok (MULT, V2SImode, operands)")
  (-1 "(ix86_unary_operator_ok (NEG, DImode, operands)) && (TARGET_64BIT)")
  (0 "TARGET_AVX && ix86_binary_operator_ok (EQ, V2DImode, operands)")
  (0 "AVX256_VEC_FLOAT_MODE_P (V4DFmode)")
  (0 "!TARGET_64BIT
   && ((TARGET_80387 && X87_ENABLE_FLOAT (SFmode, DImode)
	&& TARGET_SSE)
       || (SSE_FLOAT_MODE_P (SFmode) && TARGET_SSE_MATH))")
  ...
  (0 "TARGET_AVX && ix86_binary_operator_ok (SMAX, V4SImode, operands)")
  (0 "TARGET_80387
   && (!(SSE_FLOAT_MODE_P (XFmode) && TARGET_SSE_MATH)
       || TARGET_MIX_SSE_I387)
   && can_create_pseudo_p ()")
  ...
  (0 "TARGET_AVOID_VECTOR_DECODE && optimize_insn_for_speed_p ()")
  ...
  (-1 "(optimize_function_for_size_p (cfun) || !TARGET_PARTIAL_FLAG_REG_STALL)
   && ix86_match_ccmode (insn, CCGOCmode)
   && ix86_binary_operator_ok (ASHIFTRT, HImode, operands)")
  (0 "AVX128_VEC_FLOAT_MODE_P (V4SFmode)")
  (0 "!TARGET_64BIT && TARGET_SSE2 && TARGET_SSE_MATH")
  (0 "TARGET_MMX")
  (0 "(TARGET_SSE && !TARGET_SSE2)
   && ix86_binary_operator_ok (AND, V4SImode, operands)")
  ...
  (0 "(DImode != DImode || TARGET_64BIT)
   && SSE_FLOAT_MODE_P (SFmode) && TARGET_SSE_MATH
   && !(TARGET_INTER_UNIT_CONVERSIONS || optimize_function_for_size_p (cfun))")
  (0 "TARGET_80387 && X87_ENABLE_FLOAT (DFmode, HImode)
   && !(SSE_FLOAT_MODE_P (DFmode) && TARGET_SSE_MATH)
   && (TARGET_USE_HIMODE_FIOP || optimize_function_for_size_p (cfun))")
  (0 "TARGET_PREFETCH_SSE && !TARGET_64BIT")
  (0 "(DImode != DImode || TARGET_64BIT)
  ...
  (0 "TARGET_MMX && ix86_binary_operator_ok (SS_MINUS, V4HImode, operands)")
  (1 "!TARGET_64BIT")
  ...
  (0 "SSE_VEC_FLOAT_MODE_P (V2DFmode) && flag_finite_math_only
   && ix86_binary_operator_ok (SMAX, V2DFmode, operands)")
  (0 "TARGET_MMX && ix86_binary_operator_ok (AND, V2SImode, operands)")
  (0 "SSE_VEC_FLOAT_MODE_P (V4SFmode)
   && ix86_binary_operator_ok (XOR, V4SFmode, operands)")
  (-1 "(GET_MODE (operands[0]) == QImode || GET_MODE (operands[0]) == HImode
    || (TARGET_64BIT && GET_MODE (operands[0]) == SImode))
  ...
  (0 "(TARGET_64BIT || TARGET_KEEPS_VECTOR_ALIGNED_STACK)
   && TARGET_SSE2 && TARGET_SSE_MATH")
  (0 "TARGET_SSE2 && ix86_binary_operator_ok (PLUS, V8HImode, operands)")
  (0 "TARGET_SSE2 && ix86_binary_operator_ok (SMAX, V8HImode, operands)")
  (-1 "ix86_match_ccmode (insn, CCNOmode)
   && ix86_binary_operator_ok (XOR, HImode, operands)")
  (0 "AVX_FLOAT_MODE_P (SFmode)")
  (0 "TARGET_CMOVE")
  (0 "TARGET_64BIT
   && (TARGET_SHIFT1 || optimize_function_for_size_p (cfun))
   && ix86_binary_operator_ok (ROTATERT, DImode, operands)")
  (0 "TARGET_SSE2 && ix86_binary_operator_ok (US_PLUS, V8HImode, operands)")
  ...
  (0 "TARGET_SSE2 && ix86_binary_operator_ok (US_MINUS, V8HImode, operands)")
  (0 "TARGET_SSE && !(MEM_P (operands[1]) && MEM_P (operands[2]))")
  (0 "AVX_VEC_FLOAT_MODE_P (V2DFmode)
   && ix86_binary_operator_ok (MINUS, V2DFmode, operands)")
  (0 "AVX_VEC_FLOAT_MODE_P (V4DFmode)")
  (-1 "!TARGET_64BIT && reload_completed
  ...
  (-1 "ix86_match_ccmode (insn, CCGOCmode)
   && ix86_binary_operator_ok (MINUS, HImode, operands)")
  (0 "TARGET_SSE4_1 && ix86_binary_operator_ok (SMIN, V16QImode, operands)")
  (-1 "(ix86_match_ccmode (insn, CCGOCmode)
   && ix86_binary_operator_ok (MINUS, DImode, operands)) && (TARGET_64BIT)")
  (0 "TARGET_64BIT && ix86_match_ccmode (insn, CCNOmode)
   && !(MEM_P (operands[0]) && MEM_P (operands[1]))")
  ...
  (-1 "reload_completed
   && true_regnum (operands[0]) != true_regnum (operands[1])")
  (0 "TARGET_AVX && !(MEM_P (operands[1]) && MEM_P (operands[2]))")
  (-1 "ix86_match_ccmode (insn, CCZmode)
   && !(MEM_P (operands[1]) && MEM_P (operands[2]))
   /* Current assemblers are broken and do not allow @GOTOFF in
      ought but a memory context.  */
   && ! pic_symbolic_operand (operands[2], VOIDmode)")
  (0 "SSE_FLOAT_MODE_P (DFmode) && TARGET_SSE_MATH")
  (0 "TARGET_SSE2 && ix86_binary_operator_ok (UMIN, V16QImode, operands)")
  (-1 "!(MEM_P (operands[0]) && MEM_P (operands[1]))
   && (reload_in_progress || reload_completed
       || (ix86_cmodel == CM_MEDIUM || ix86_cmodel == CM_LARGE)
  ...
  (0 "TARGET_3DNOW && ix86_binary_operator_ok (EQ, V2SFmode, operands)")
  (0 "TARGET_80387 && X87_ENABLE_FLOAT (XFmode, DImode)
   && TARGET_SSE2 && TARGET_INTER_UNIT_MOVES
   && !TARGET_64BIT && optimize_function_for_speed_p (cfun)
   && reload_completed
  ...
  (0 "(SImode != DImode || TARGET_64BIT)
   && SSE_FLOAT_MODE_P (SFmode) && TARGET_MIX_SSE_I387
   && (TARGET_INTER_UNIT_CONVERSIONS || optimize_function_for_size_p (cfun))")
  (0 "TARGET_AVX && !(MEM_P (operands[0]) && MEM_P (operands[1]))")
  (0 "TARGET_SSE2 && ix86_binary_operator_ok (XOR, V4SImode, operands)")
  (0 "TARGET_SSE2 && ix86_binary_operator_ok (IOR, V8HImode, operands)")
  (0 "TARGET_80387
   || ((DImode != DImode || TARGET_64BIT)
       && SSE_FLOAT_MODE_P (SFmode) && TARGET_SSE_MATH)")
  (0 "TARGET_SSE3")
  (-1 "exact_log2 (INTVAL (operands[1])) >= 0
   && peep2_regno_dead_p (0, FLAGS_REG)")
  (0 "TARGET_AVX && ix86_binary_operator_ok (US_MINUS, V16QImode, operands)")
  (0 "TARGET_64BIT && ((optimize > 0 && flag_peephole2)
		    ? epilogue_completed : reload_completed)")
  (0 "(TARGET_SSE && !TARGET_SSE2)
   && ix86_binary_operator_ok (IOR, V16QImode, operands)")
  ...
  (0 "TARGET_AVX
   && (register_operand (operands[0], V4SFmode)
       || register_operand (operands[1], V4SFmode))")
  (0 "TARGET_MMX && ix86_binary_operator_ok (IOR, V8QImode, operands)")
  (0 "TARGET_AVX")
  (0 "SSE_FLOAT_MODE_P (DFmode) && TARGET_SSE_MATH
   && !flag_trapping_math")
  (0 "TARGET_SHORTEN_X87_SSE
   && peep2_reg_dead_p (2, operands[0])")
  (-1 "(TARGET_SHIFT1 || optimize_function_for_size_p (cfun))
   && ix86_binary_operator_ok (ROTATERT, HImode, operands)")
  (0 "TARGET_AVX && ix86_binary_operator_ok (SMAX, V8HImode, operands)")
  (0 "TARGET_SSSE3")
  (0 "AVX_VEC_FLOAT_MODE_P (V8SFmode)
