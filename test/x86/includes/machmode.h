...
/***********************************************************************/
#define GET_MODE_CLASS_EQ_MODE_RANDOM(MODE) ((MODE) >= VOIDmode && (MODE) <= BLKmode)
#define GET_MODE_CLASS_EQ_MODE_CC(MODE) ((MODE) >= CCmode && (MODE) <= CCFPUmode)
#define GET_MODE_CLASS_EQ_MODE_INT(MODE) 	((MODE) >= BImode && (MODE) <= OImode)
#define GET_MODE_CLASS_EQ_MODE_FRACT(MODE) ((MODE) >= QQmode && (MODE) <= TQmode)
#define GET_MODE_CLASS_EQ_MODE_UFRACT(MODE) ((MODE) >= UQQmode && (MODE) <= UTQmode)
#define GET_MODE_CLASS_EQ_MODE_ACCUM(MODE) ((MODE) >= HAmode && (MODE) <= TAmode)
#define GET_MODE_CLASS_EQ_MODE_UACCUM(MODE) ((MODE) >= UHAmode && (MODE) <= UTAmode)
#define GET_MODE_CLASS_EQ_MODE_FLOAT(MODE) ((MODE) >= SFmode && (MODE) <= TFmode)
#define GET_MODE_CLASS_EQ_MODE_DECIMAL_FLOAT(MODE) ((MODE) >= SDmode && (MODE) <= TDmode)
#define GET_MODE_CLASS_EQ_MODE_COMPLEX_INT(MODE) ((MODE) >= CQImode && (MODE) <= COImode)
#define GET_MODE_CLASS_EQ_MODE_COMPLEX_FLOAT(MODE) ((MODE) >= SCmode && (MODE) <= TCmode) 
#define GET_MODE_CLASS_EQ_MODE_PARTIAL_INT(MODE) (0)
#define GET_MODE_CLASS_EQ_MODE_VECTOR_INT(MODE) ((MODE) >= V2QImode && (MODE) <= V4TImode)
#define GET_MODE_CLASS_EQ_MODE_VECTOR_FLOAT(MODE) ((MODE) >= V2SFmode && (MODE) <= V4TFmode)
/***********************************************************************/
...
#define INTEGRAL_MODE_P(MODE)			\
  (GET_MODE_CLASS_EQ_MODE_INT(MODE)		\
   ...
   || GET_MODE_CLASS_EQ_MODE_COMPLEX_INT(MODE) \
   || GET_MODE_CLASS_EQ_MODE_VECTOR_INT(MODE))

/* Nonzero if MODE is a floating-point mode.  */
#define FLOAT_MODE_P(MODE)		\
  (GET_MODE_CLASS_EQ_MODE_FLOAT(MODE)	\
   || GET_MODE_CLASS_EQ_MODE_DECIMAL_FLOAT(MODE) \
   || GET_MODE_CLASS_EQ_MODE_COMPLEX_FLOAT(MODE) \
   || GET_MODE_CLASS_EQ_MODE_VECTOR_FLOAT(MODE))
...
#define VECTOR_MODE_P(MODE)			\
  (GET_MODE_CLASS_EQ_MODE_VECTOR_INT(MODE)	\
   || GET_MODE_CLASS_EQ_MODE_VECTOR_FLOAT(MODE)	\
   || GET_MODE_CLASS_EQ_MODE_VECTOR_FRACT(MODE)	\
   || GET_MODE_CLASS_EQ_MODE_VECTOR_UFRACT(MODE)	\
   || GET_MODE_CLASS_EQ_MODE_VECTOR_ACCUM(MODE)	\
   || GET_MODE_CLASS_EQ_MODE_VECTOR_UACCUM(MODE))
...
#define SCALAR_FLOAT_MODE_P(MODE)		\
  (GET_MODE_CLASS_EQ_MODE_FLOAT		\
   || GET_MODE_CLASS_EQ_MODE_DECIMAL_FLOAT)
#define SCALAR_FLOAT_MODE_P(MODE) \
