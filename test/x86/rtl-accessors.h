...
#ifndef RTL_ACCESSORS_H
#define RTL_ACCESSORS_H
...
#include "symHelper.h"
static void RTL_CHECKC1_CONS(const rtx* rtxAddr, unsigned int n, enum rtx_code c);
...
unsigned int X0UINT (const_rtx r, int n);
...
int MARK_CONSTRAINT_CONSTRAINT(const rtx x);
